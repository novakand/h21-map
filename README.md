...
| Outputs               | Описание                                                                                                                                                                                                                                                             |
|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| responseDirectGeocoding  |Ответ от прямого геокодирования. <br> Тип:Subject `IPosition`  |  
| responseReverseGeocoding  |Ответ от обратного геокодирования. <br> Тип:Subject `IPoint`  |  
